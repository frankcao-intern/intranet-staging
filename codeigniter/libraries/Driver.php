...
class CI_Driver_Library {
	...
	{
		if ( ! isset(CI_Driver_Library::$lib_name)){
			CI_Driver_Library::$lib_name = get_class($this);
		}

		// The class will be prefixed with the parent lib
		$child_class = CI_Driver_Library::$lib_name.'_'.$child;
	
		// Remove the CI_ prefix and lowercase
		$lib_name = ucfirst(strtolower(str_replace('CI_', '', CI_Driver_Library::$lib_name)));
