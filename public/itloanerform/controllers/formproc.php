...
$subject = "IT Equipment Loan Request Form - $reqTimeStamp";
...
mail($to, $subject, $body, $headers) or
	die("<p>There was an error sending your confirmation email. This is your reference: $reqTimeStamp<p>");
...
$body = "Hello ".$_POST['mUserName'].",<br><br>\n\nAn IT Equipment Loan Request Form was filled by: ".$_POST['userName']." and you were listed as his/her leader, or you are the Director or VP of the area. ";
