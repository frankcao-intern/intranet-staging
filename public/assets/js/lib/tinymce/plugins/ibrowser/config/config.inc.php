<?php
	...
	$cfg['valid']  		= array('gif', 'jpg', 'jpeg', 'png', 'tif');						// valid extentions for image files	
	$cfg['upload'] 		= true; 													// allow uploading of image: 'true' or 'false'
	$cfg['umax'] 		= 5;														// max. number of image files to be uploaded; default: 1; value > 1
	...
	$cfg['ilibs_dir'] 	   = array('/piclibrary/');						   	// image library path with slashes; absolute to root directory - please make sure that the directories have write permissions
	...
	$cfg['base_url'] 	= 'https://' . $_SERVER['SERVER_NAME']; 						// base url; e.g. 'http://localhost/'
