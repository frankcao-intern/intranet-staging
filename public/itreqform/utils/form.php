...
<form method="post" name="reqForm" id="reqForm" action="<?php echo $action; ?>">
	...
	<fieldset id="newSoft" class="hidethis" style="display: none">
		...
		<span id="sOtherStr" class="hidethis" style="display: none">
			<label>Specify: <input type="text" name="sOtherStr" value="<?php if (isset($dataArr['sOtherStr'])) echo $dataArr['sOtherStr']; ?>" style="width: 540px; " /></label>
		</span>
	...
	<fieldset id="newHardware" class="hidethis" style="display: none">
		...
		<fieldset class="radios">
			<label>
				<input type="radio" name="computer" value="Dell Laptop" id="compLaptop"
						<?php if (isset($computer1)) echo $computer1; ?> />Laptop
			</label>
			<label>
		...
		<label><input type="checkbox" name="h7" value="iPhone (Verizon)"	<?php if (isset($dataArr['h7'])) echo $checked; ?> />iPhone (Verizon)</label>
