...
<link rel="stylesheet" type="text/css" href="<?=STATIC_URL?>css/screen_NEW.css" media="all" />
				...
				<?php if (isset($article[0])): ?>
					...
					?>
						...
						<iframe 
							...
							id="vimeo-player-1" width="759"	height="427" frameborder="0" data-progress="true" data-seek="true" data-bounce="true"
							webkitAllowFullScreen mozallowfullscreen allowFullScreen>
									alt="<?=htmlentities($articleRev->main_image[0]->alt, ENT_COMPAT, 'UTF-8', false)?>
						</iframe>
						<!--script src="https://ajax.googleapis.com/ajax/libs/jquery/1.4.3/jquery.min.js"></script>
						<script src="<?=STATIC_URL?>js/lib/vimeo.ga.min.js"></script-->
