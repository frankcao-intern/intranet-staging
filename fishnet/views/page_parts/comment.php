...
<div class="comment-a <?php echo $comment_class.' '.$author.' '.$staff.' '.$admin?>" id="comment-<?php echo $commID?>">
	<div>
		<a href="<?php echo $commID?>" title="<?php echo $comment['display_name']?>">
			<a href="<?php echo site_url("profiles/".$comment['user_id'])?>" title="<?php echo $comment['display_name']?>">
				<img height="64" class="avatar" src="<?php echo $comment['user_picture']?>/w/64/zc/64"
					alt="<?php echo $comment['display_name']?>">
		</a>
		<p class="meta">
			...
			<span class="author">
				<em>
					<?php echo anchor("profiles/".$comment['user_id'], $comment['display_name'],
