...
<br>
	<?php if ($this->session->userdata('show_apps')): ?>
		<!--div class="icons"-->
		<div class="icons">
			<?=anchor('/departments/4711', 'vision2020', 'class="vision2020"')?>
		</div>
		
		<div class="icons section-a">
			<?=anchor('/article/3484', 'optank', 'class="optank"')?>
		</div>
		...
		<!--div id="photoshow"-->
			<!--div class="current">
				<a href='/btl'>
				<img src='/assets/images/Pro_ed_image_homepage-final.png' alt='btl' style="border: 1px solid transparent; width: 200px; height: 90px;">
				</a>	
			</div-->
			<!--div>
				<a href="/priorities">
	...
	<div class="section-a" style="margin-top: 0px;">
		<div id="calendar">
		<h2 class="c" style="margin-bottom: 2px;">
	...
	<script type="application/template" id="efphotosTempl">
		<div class="section-a" style="margin-top: 0px;">
			...
			<div class="efphoto">
				<!--p class="more-c" style="margin-bottom: 5px;"><?=anchor('photos', "SEE MORE SNAPSHOTS")?></p-->
				<br>
